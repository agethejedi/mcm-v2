...
// Current Dow 30 universe
export const DOW30 = [
  { symbol: "AAPL", name: "Apple",             threshold: 0.006, category: "Mega-cap Liquidity Leader", cohort: "liquidity_leader" },
  { symbol: "MSFT", name: "Microsoft",         threshold: 0.005, category: "Mega-cap Liquidity Leader", cohort: "liquidity_leader" },
  { symbol: "NVDA", name: "NVIDIA",            threshold: 0.010, category: "AI / Semis / Liquidity",    cohort: "liquidity_leader" },
  { symbol: "V",    name: "Visa",              threshold: 0.010, category: "Payments / Spending",        cohort: "liquidity_leader" },
  { symbol: "IBM",  name: "IBM",               threshold: 0.007, category: "Value Tech / Rebalancing",   cohort: "liquidity_leader" },

  { symbol: "CRM",  name: "Salesforce",        threshold: 0.010, category: "Enterprise Software / IT Budgets", cohort: "reflex_bounce" },
  { symbol: "AMZN", name: "Amazon",            threshold: 0.010, category: "Consumer / Cloud / Retail",       cohort: "reflex_bounce" },
  { symbol: "NKE",  name: "Nike",              threshold: 0.010, category: "Consumer Discretionary",          cohort: "reflex_bounce" },
  { symbol: "DIS",  name: "Disney",            threshold: 0.012, category: "Consumer / Media",                cohort: "reflex_bounce" },
  ...
  { symbol: "SHW",  name: "Sherwin-Williams",  threshold: 0.010, category: "Materials / Industrial Coatings", cohort: "cyclical" },
  ...
  { symbol: "WMT",  name: "Walmart",           threshold: 0.007, category: "Defensive / Staples / Scale", cohort: "defensive" }
];
